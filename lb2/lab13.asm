...
start: 
    ...
    ; Ввод ключа (один символ)
    mov ah, 01h
    int 21h
    mov key, al             ; Сохраняем введенный символ в key
...
; Процедура расшифровки: деление на ключ (обратно к умножению в encrpt)
crypt proc
nextIterByte:
    sub [si], al            ; Дешифрование вычитанием
    inc si
    loop nextIterByte
    ret
crypt endp 
